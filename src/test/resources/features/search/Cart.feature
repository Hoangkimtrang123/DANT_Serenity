...
#    Given the have searched for the product "Son"
#    When the user TRANG select the "Son" product with quantity "1"
#    And the user add the product to the cart
#    Then the user should see the "son" product in my cart
#
#  @cart
